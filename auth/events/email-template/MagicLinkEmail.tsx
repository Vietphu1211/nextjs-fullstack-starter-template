        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Welcome to <strong style={{ color: '#27ae60' }}>SafeCar</strong> - your trusted source for premium transportation services.
            </Text>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              © {new Date().getFullYear()} SafeCar. All rights reserved.
            </Text>
            <Text style={footerText}>
              🚐 SafeCar - Your trusted transportation partner
            </Text>
          </Section>
        </Container>
      </Section>
